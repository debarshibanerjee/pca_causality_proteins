...
DEFAULT_INPUT_DIR = Path("analysis_outputs/ig_results/r2-70_E=1_k=50_dci=0")
PC_PAIRS_TO_PLOT = ((2, 3), (2, 4), (2, 5), (3, 4), (3, 5), (4, 5))
GRID_SHAPE = (3, 2)
OUTPUT_FILENAME = "IG_selected_pairs_smoothed_grid_r2-70_SI.png"
...
SHADE_ALPHA = 0.2
X_AXIS_MAX_NS = 500.0
X_TICKS_NS = np.arange(0.0, 501.0, 100.0)
...
def build_pair_input_path(input_dir: Path, pair: tuple[int, int]) -> Path:
    pc_a, pc_b = pair
    pattern = f"IG-pc{pc_a}_vs_pc{pc_b}_*.txt"
