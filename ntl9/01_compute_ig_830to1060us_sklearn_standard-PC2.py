...
def main():
    ...
    #!# max duration of time lag; 5000 frames = 1.0 us
    tau_end = 5000  #!# 1.0 us
    ...
    ## Create a new directory called 'iib_data/830to1060us_sklearn_standard_pc2'
    save_data_directory = os.path.join(current_directory, "iib_data", "830to1060us_sklearn_standard_pc2")
