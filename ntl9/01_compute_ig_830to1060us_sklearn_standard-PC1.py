...
def main():
    ...
    ## Create a new directory called 'iib_data/830to1060us_sklearn_standard_pc1'
    save_data_directory = os.path.join(current_directory, "iib_data", "830to1060us_sklearn_standard_pc1")
